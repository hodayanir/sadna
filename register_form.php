                 ...
                 <h3 class="mb-30">Registration Form</h3>
					<form action="register.php" method="post" id="contactForm">
							<div class="mt-10">
								...
								<div class="mt-10">
									<input type="int" name="phone_number" placeholder="Phone Number"
								...
								<div class="mt-10">
									<div class="icon">
									<input type="password" name="password" placeholder="Password again" onfocus="this.placeholder = ''"
										onblur="this.placeholder = 'Password'" required class="single-input">
									</div>
								</div>		
								<div class="mt-10">
									<textarea class="single-textarea" type="description" name="description" placeholder="Description" onfocus="this.placeholder = ''"
										onblur="this.placeholder = 'Description'" required></textarea>
								</div>
								
								<div class="form-group mt-3">
                                <button type="submit" class="button button-contactForm boxed-btn" id="register">Register</button>
                                </div>
						 </form> 
					</div>
                </div>
